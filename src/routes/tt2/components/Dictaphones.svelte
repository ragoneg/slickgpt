<script lang="ts">
	import Button from '$lib/speech/components/Button.svelte';
	import Listen from '$lib/speech/components/Listen.svelte';
	import Stop from '$lib/speech/components/Stop.svelte';
